...
Eigen::Quaterniond QuaternionParameterization::DeltaQ(const Eigen::Vector3d& dAlpha) const
{
  Eigen::Vector4d dq;
...
bool QuaternionParameterization::Plus(const double* x, const double* delta,
...
bool QuaternionParameterization::Minus(const double* x, const double* x_plus_delta,
 double* delta) const
{
...
bool QuaternionParameterization::ComputeLiftJacobian(
    const double* x, double* jacobian) const
{
  return liftJacobian(x, jacobian);
}

bool QuaternionParameterization::plusJacobian(
    const double* x, double* jacobian) const
{
...
bool QuaternionParameterization::liftJacobian(
    const double* x, double* jacobian) const
{
...
bool QuaternionParameterization::ComputeJacobian(
    const double* x, double* jacobian) const
{
  return plusJacobian(x, jacobian);
}

bool QuaternionParameterization::VerifyJacobianNumDiff(
    const double* x,
    double* jacobian,
...
bool QuaternionParameterization::Verify(
    const double* x_raw, double perturbation_magnitude) const
{
...
Eigen::Matrix4d QuaternionParameterization::oplus(
...
Eigen::Matrix4d QuaternionParameterization::qplus(
    const Eigen::Quaterniond &q_BC) const
{
  Eigen::Vector4d q = q_BC.coeffs();
  Eigen::Matrix4d Q;
