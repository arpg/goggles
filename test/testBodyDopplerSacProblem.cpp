...
TEST(goggleTests, testBodyDopplerSacProblem)
{
  ...
  pcl::BodyDopplerSacModel<pcl::PointXYZ>::Ptr model(
    new pcl::BodyDopplerSacModel<pcl::PointXYZ>(targets));
  std::vector<int> inliers;
  pcl::MaximumLikelihoodSampleConsensus<pcl::PointXYZ> mlesac(model);
